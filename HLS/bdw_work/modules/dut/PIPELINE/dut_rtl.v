...
module dut(clk, rst, din_busy, din_vld, din_data_a, din_data_b, din_data_c, din_data_d, din_data_e, din_data_f, din_data_g, din_data_h, dout_busy, dout_vld, dout_data);
      ...
      wire[31:0] arr_out1;
          ...
          begin :drive_dout_data
            case (stall0) 
               ...
               1'b0:                begin
                  ...
                  // in function put called from dut.cc:81:8
                  dout_data <= {arr_out1, {s_reg_50, {s_reg_49, {s_reg_48, {s_reg_47, {s_reg_44, {s_reg_43, s_reg_46}}}}}}};
               end
               ...
               1'b0:                begin
                  case (global_state) 
                     ...
                     5'd16:                      begin
                        ...
                        // at: dut.cc:61:5
                        // Call Stack: 
                        // in function thread1 called from dut.cc:61:5
               ...
               1'b0:                begin
                  case (global_state) 
                     ...
                     5'd18:                      begin
                        ...
                        // at: dut.cc:73:34
                        // Call Stack: 
                        // in function thread1 called from dut.cc:73:34
                        s_reg_43 <= arr_out1;
                     end
               ...
               1'b0:                begin
                  case (global_state) 
                     ...
                     5'd11:                      begin
                        ...
                        s_reg_44 <= dut_Add_32Sx2S_32S_4_10_out1;
                     end
                     ...
                     5'd19:                      begin
                        ...
                        // at: dut.cc:74:34
                        // Call Stack: 
                        // in function thread1 called from dut.cc:74:34
                        s_reg_44 <= arr_out1;
                     end
          ...
          begin :drive_s_reg_45
            case (stall0) 
               ...
               1'b0:                begin
                  ...
                  // Call Stack: 
                  // in function thread1 called from dut.cc:57:26
                  s_reg_45 <= dut_LessThan_33Sx33S_1U_4_11_out1;
               end
            ...
            case (stall0) 
               ...
               1'b0:                begin
                  case (global_state) 
                     ...
                     5'd11, 5'd13, 5'd17:                      begin
                        // op:thread1/OP97
                        // at: dut.cc:61:21
                        // Call Stack: 
                        // in function thread1 called from dut.cc:61:21
                        s_reg_46 <= arr_out1;
                     end
         ...
         // at: dut.cc:79:34
         always @(s_reg_40[2:0] or s_reg_41 or s_reg_42 or s_reg_43[2:0] or s_reg_45 or dut_N_Mux_3_2_0_4_13_out1 or gs_ctrl0)
          begin :drive_arr_in1
            case (gs_ctrl0) 
               ...
               4'd08:                begin
                  ...
                  // at: dut.cc:66:16
                  // Call Stack: 
                  // in function thread1 called from dut.cc:66:16
               ...
               4'd12:                begin
                  if (s_reg_41) begin
                     ...
                     // at: dut.cc:72:34
                     // Call Stack: 
                     // in function thread1 called from dut.cc:72:34
                     arr_in1 = 3'd0;
                  end
               end
         ...
         // at: dut.cc:68:19
         always @(din_data_a or s_reg_34 or s_reg_35 or s_reg_36 or s_reg_37 or s_reg_38 or s_reg_39 or s_reg_40 or s_reg_46 or arr_out1 or gs_ctrl1)
          begin :drive_arr_DIN
            case (gs_ctrl1) 
         ...
         // Implements 1 operation(s)
         // at: dut.cc:61:16
         assign dut_LessThan_32Ux32U_1U_4_12_out1 = arr_out1 < s_reg_46;
         ...
         //   SRCLOC: cynw_p2p.h:5073:4
         //    FSM: global_state == 25
         always @(s_reg_41 or s_reg_45 or dut_LessThan_5Sx5S_1U_4_9_out1 or global_state)
               ...
               case (stall0) 
                  ...
                  1'b0:                   begin
                     case (global_state_next) 
                        ...
                        5'd01, 5'd02, 5'd03, 5'd04, 5'd05, 5'd06, 5'd07, 5'd08, 5'd10, 5'd11, 5'd12, 5'd13, 5'd14, 5'd15, 5'd17, 5'd18, 5'd19, 5'd20, 5'd21, 5'd22, 5'd23:                         begin
                           gs_ctrl2 <= 2'd1;
                        end
               ...
               case (stall0) 
                  ...
                  1'b0:                   begin
                     case (global_state_next) 
                        ...
                        5'd01, 5'd02, 5'd03, 5'd04, 5'd05, 5'd06, 5'd07, 5'd08, 5'd14, 5'd15:                         begin
                           gs_ctrl3 <= 1'b1;
                        end
