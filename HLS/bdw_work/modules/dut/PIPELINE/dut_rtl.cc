...
void dut::drive_dout_data(){
  ...
  case 0ULL: 
    dout_data = ( (sc_biguint<256> )(sc_bv<256>)((sc_bv<32>)(arr_out1.read()), 
                ...
                (sc_bv<96>)((sc_bv<32>)(s_reg_44.read()), 
                (sc_bv<64>)((sc_bv<32>)(s_reg_43.read()), 
                (sc_bv<32>)((sc_biguint<32> )s_reg_46.read())))))))) );
    break;
  }
}
...
void dut::drive_s_reg_44(){
  ...
  case 0ULL: 
    switch( (sc_uint<5>)(global_state.read()) ) {
    case 11ULL: 
      s_reg_44 = (sc_uint<32> ) (dut_Add_32Sx2S_32S_4_10_out1.read());
      break;
    case 19ULL: 
...
void dut::drive_s_reg_45(){
  ...
  case 1ULL: 
    break;
  case 0ULL: 
    s_reg_45 = dut_LessThan_33Sx33S_1U_4_11_out1.read();
    break;
  }
}
// resource: regr_en_32
  ...
  if ( (rst.read() == 0ULL) ) {
    ...
    case 0ULL: 
      ...
      default:
        gs_ctrl0 = 0ULL;
        break;
      case 2ULL: case 17ULL: 
        gs_ctrl0 = 1ULL;
        break;
      case 3ULL: case 18ULL: 
        gs_ctrl0 = 2ULL;
        break;
      case 4ULL: case 19ULL: 
        gs_ctrl0 = 3ULL;
        break;
      case 5ULL: case 20ULL: 
        gs_ctrl0 = 4ULL;
        break;
      case 6ULL: case 21ULL: 
        gs_ctrl0 = 5ULL;
        break;
      case 7ULL: case 22ULL: 
        gs_ctrl0 = 6ULL;
        break;
      case 8ULL: case 23ULL: 
        gs_ctrl0 = 7ULL;
        break;
...
void dut::drive_gs_ctrl2(){
  if ( (rst.read() == 0ULL) ) {
    ...
    case 0ULL: 
      ...
      7ULL: case 8ULL: case 10ULL: case 11ULL: case 12ULL: case 13ULL: case 
      14ULL: case 15ULL: case 17ULL: case 18ULL: case 19ULL: case 20ULL: case 
      21ULL: case 22ULL: case 23ULL: 
        gs_ctrl2 = 1ULL;
        break;
      case 9ULL: 
        gs_ctrl2 = 2ULL;
  ...
  if ( (rst.read() == 0ULL) ) {
    ...
    case 0ULL: 
      ...
      default:
        ...
        break;
      case 1ULL: case 2ULL: case 3ULL: case 4ULL: case 5ULL: case 6ULL: case 
      7ULL: case 8ULL: case 14ULL: case 15ULL: 
        gs_ctrl3 = 1ULL;
        break;
      }
      break;
