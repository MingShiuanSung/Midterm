...
dut::dut(sc_module_name name) : sc_module(name) 
    ...
    ,dut_N_Muxb_1_2_8_4_1_out1("dut_N_Muxb_1_2_8_4_1_out1")
    ...
    ,dut_Add2i1u3_4_8_in1("dut_Add2i1u3_4_8_in1")
    ,gs_ctrl4("gs_ctrl4")
    ,gs_ctrl3("gs_ctrl3")
    ,gs_ctrl2("gs_ctrl2")
    ,dut_Lti8s5_4_9_out1("dut_Lti8s5_4_9_out1")
    ,gs_ctrl1("gs_ctrl1")
    ,gs_ctrl0("gs_ctrl0")
    ,dut_Lti8s32_4_11_out1("dut_Lti8s32_4_11_out1")
    ,dut_Add2i1s32_4_10_out1("dut_Add2i1s32_4_10_out1")
    ,dut_Add2i1u3_4_8_out1("dut_Add2i1u3_4_8_out1")
    ,dut_N_Mux_3_2_15_4_13_out1("dut_N_Mux_3_2_15_4_13_out1")
    ,s_reg_42("s_reg_42")
    ,dut_Lti7s5_4_15_out1("dut_Lti7s5_4_15_out1")
    ,s_reg_41("s_reg_41")
    ,dut_Add2i1u3_4_14_out1("dut_Add2i1u3_4_14_out1")
    ,s_reg_46("s_reg_46")
    ,s_reg_40("s_reg_40")
    ,s_reg_39("s_reg_39")
    ,s_reg_38("s_reg_38")
    ...
    ,arr_out1("arr_out1")
{
  ...
  sensitive << ( s_reg_43 );
  sensitive << ( s_reg_46 );
  sensitive << ( dut_N_Mux_3_2_15_4_13_out1 );
  sensitive << ( s_reg_42 );
  sensitive << ( s_reg_41 );
  ...
  SC_METHOD(drive_dut_Add2i1u3_4_8_in1);
  sensitive << ( gs_ctrl4 );
  sensitive << ( s_reg_40 );

  SC_METHOD(dut_Add2i1u3_4_8);
  sensitive << ( dut_Add2i1u3_4_8_in1 );

  SC_METHOD(dut_Lti8s5_4_9);
  sensitive << ( dut_Add2i1u3_4_8_out1 );

  SC_METHOD(dut_Add2i1s32_4_10);
  sensitive << ( s_reg_43 );

  SC_METHOD(dut_Lti8s32_4_11);
  sensitive << ( dut_Add2i1s32_4_10_out1 );

  SC_METHOD(dut_LessThan_32Ux32U_1U_4_12);
  sensitive << ( s_reg_44 );
  sensitive << ( arr_out1 );

  SC_METHOD(dut_N_Mux_3_2_15_4_13);
  sensitive << ( dut_LessThan_32Ux32U_1U_4_12_out1 );
  sensitive << ( s_reg_43 );
  sensitive << ( s_reg_42 );

  SC_METHOD(dut_Add2i1u3_4_14);
  sensitive << ( s_reg_40 );

  SC_METHOD(dut_Lti7s5_4_15);
  sensitive << ( s_reg_40 );
  ...
  SC_METHOD(dut_N_Muxb_1_2_8_4_1);
  sensitive << ( din_m_busy_req_0 );
  sensitive << ( din_m_unvalidated_req );
  sensitive << ( din_vld );
...
void dut::drive_s_reg_40(){
  ...
  case 0ULL: 
    ...
    case 13ULL: 
      ...
      break;
    case 15ULL: 
      s_reg_40 = (sc_uint<8> ) (dut_Add2i1u3_4_14_out1.read());
      break;
    case 17ULL: 
      s_reg_40 = (sc_uint<8> ) ((sc_int<5> )s_reg_40.read());
      break;
...
void dut::drive_s_reg_41(){
  ...
  case 1ULL: 
    break;
  case 0ULL: 
    s_reg_41 = dut_Lti7s5_4_15_out1.read();
    break;
  }
}
...
void dut::drive_s_reg_42(){
  ...
  case 0ULL: 
    ...
    case 9ULL: 
      ...
      break;
    case 13ULL: 
      s_reg_42 = (sc_uint<3> ) (dut_N_Mux_3_2_15_4_13_out1.read());
      break;
    case 17ULL: 
...
void dut::drive_s_reg_43(){
  ...
  case 0ULL: 
    ...
    case 9ULL: case 17ULL: 
      s_reg_43 = (sc_uint<32> ) (dut_Add2i1u3_4_8_out1.read());
      break;
    case 13ULL: 
...
void dut::drive_s_reg_45(){
  ...
  case 0ULL: 
    switch( (sc_uint<5>)(global_state.read()) ) {
    case 12ULL: 
      s_reg_45 = (sc_uint<32> ) (dut_Add2i1s32_4_10_out1.read());
      break;
    case 20ULL: 
...
void dut::drive_s_reg_46(){
  ...
  case 1ULL: 
    break;
  case 0ULL: 
    s_reg_46 = dut_Lti8s32_4_11_out1.read();
    break;
  }
}
// resource: regr_en_32
...
void dut::drive_arr_in1(){
  ...
  case 10ULL: 
    if ( s_reg_46.read() ) {
      /* state29 */
      arr_in1 = (sc_uint<3> ) (dut_N_Mux_3_2_15_4_13_out1.read());
    } else {
      arr_in1 = (sc_uint<3> )s_reg_40.read();
    }
    break;
...
void dut::drive_dut_Add2i1u3_4_8_in1(){
  if ( gs_ctrl4.read() ) {
    dut_Add2i1u3_4_8_in1 = (sc_uint<3> )s_reg_40.read();
  } else {
    dut_Add2i1u3_4_8_in1 = 0ULL;
  }
}
// resource: dut_Add2i1u3_4  instance: dut_Add2i1u3_4_8
void dut::dut_Add2i1u3_4_8(){
  dut_Add2i1u3_4_8_out1 = (/*cliff*/sc_int<32>)(dut_Add2i1u3_4_8_in1.read() + 
                          1LL);
}
// resource: dut_Lti8s5_4  instance: dut_Lti8s5_4_9
void dut::dut_Lti8s5_4_9(){
  dut_Lti8s5_4_9_out1 = (/*imp*/sc_uint<1>)(dut_Add2i1u3_4_8_out1.read() < (
                        sc_int<5> )8LL);
}
// resource: dut_Add2i1s32_4  instance: dut_Add2i1s32_4_10
void dut::dut_Add2i1s32_4_10(){
  dut_Add2i1s32_4_10_out1 = (/*cliff*/sc_int<32>)((sc_int<32> )s_reg_43.read()
                             + 1LL);
}
// resource: dut_Lti8s32_4  instance: dut_Lti8s32_4_11
void dut::dut_Lti8s32_4_11(){
  dut_Lti8s32_4_11_out1 = (/*imp*/sc_uint<1>)(dut_Add2i1s32_4_10_out1.read() < (
                          sc_int<5> )8LL);
}
...
// resource: dut_N_Mux_3_2_15_4
void dut::dut_N_Mux_3_2_15_4_13(){
  if ( dut_LessThan_32Ux32U_1U_4_12_out1.read() ) {
    dut_N_Mux_3_2_15_4_13_out1 = (sc_uint<3> )s_reg_43.read();
  } else {
    dut_N_Mux_3_2_15_4_13_out1 = (sc_uint<3> ) (s_reg_42.read());
  }
}
// resource: dut_Add2i1u3_4  instance: dut_Add2i1u3_4_14
void dut::dut_Add2i1u3_4_14(){
  dut_Add2i1u3_4_14_out1 = (/*cliff*/sc_int<32>)((sc_uint<3> )s_reg_40.read() + 
                           1LL);
}
// resource: dut_Lti7s5_4  instance: dut_Lti7s5_4_15
void dut::dut_Lti7s5_4_15(){
  dut_Lti7s5_4_15_out1 = (/*imp*/sc_uint<1>)((sc_int<5> )s_reg_40.read() < (
                         sc_int<4> )7LL);
}
...
void dut::drive_din_m_unvalidated_req(){
  if ( (rst.read() == 0ULL) ) {
    ...
    din_m_unvalidated_req = (sc_uint<1> ) (dut_N_Muxb_1_2_8_4_1_out1.read());
  }
}
// resource: dut_N_Muxb_1_2_8_4
void dut::dut_N_Muxb_1_2_8_4_1(){
  if ( din_m_busy_req_0.read() ) {
    dut_N_Muxb_1_2_8_4_1_out1 = (sc_uint<1> ) (din_m_unvalidated_req.read());
  } else {
    dut_N_Muxb_1_2_8_4_1_out1 = (sc_uint<1> ) (din_vld.read());
  }
}
