...
module dut(clk, rst, din_busy, din_vld, din_data_a, din_data_b, din_data_c, din_data_d, din_data_e, din_data_f, din_data_g, din_data_h, dout_busy, dout_vld, dout_data);
      ...
      reg[2:0] dut_Add2i1u3_4_8_in1;
      reg gs_ctrl4;
      reg gs_ctrl3;
      wire dut_Lti8s5_4_9_out1;
      reg[1:0] gs_ctrl2;
      reg[3:0] gs_ctrl1;
      reg[3:0] gs_ctrl0;
      wire dut_Lti8s32_4_11_out1;
      /*signed*/wire[31:0] dut_Add2i1s32_4_10_out1;
      /*signed*/wire[4:0] dut_Add2i1u3_4_8_out1;
      reg[2:0] dut_N_Mux_3_2_15_4_13_out1;
      reg[2:0] s_reg_42;
      wire dut_Lti7s5_4_15_out1;
      reg s_reg_41;
      /*signed*/wire[4:0] dut_Add2i1u3_4_14_out1;
      reg s_reg_46;
      reg[7:0] s_reg_40;
      reg[7:0] s_reg_39;
      reg[7:0] s_reg_38;
      ...
      wire[31:0] arr_out1;
               ...
               1'b0:                begin
                  case (global_state) 
                     ...
                     5'd15:                      begin
                        ...
                        s_reg_40 <= {{ 3 {dut_Add2i1u3_4_14_out1[4]}}, dut_Add2i1u3_4_14_out1};
                     end
               ...
               1'b0:                begin
                  case (global_state) 
                     ...
                     5'd13:                      begin
                        ...
                        // at: dut.cc:57:26
                        // Call Stack: 
                        // in function thread1 called from dut.cc:57:26
                        s_reg_42 <= dut_N_Mux_3_2_15_4_13_out1;
                     end
               ...
               1'b0:                begin
                  case (global_state) 
                     ...
                     5'd09, 5'd17:                      begin
                        ...
                        s_reg_43 <= {{ 27 {dut_Add2i1u3_4_8_out1[4]}}, dut_Add2i1u3_4_8_out1};
                     end
               ...
               1'b0:                begin
                  case (global_state) 
                     ...
                     5'd12, 5'd14, 5'd18:                      begin
                        ...
                        // at: dut.cc:64:21
                        // Call Stack: 
                        // in function thread1 called from dut.cc:64:21
                        s_reg_44 <= arr_out1;
                     end
               ...
               1'b0:                begin
                  case (global_state) 
                     ...
                     5'd12:                      begin
                        ...
                        s_reg_45 <= dut_Add2i1s32_4_10_out1;
                     end
          ...
          begin :drive_s_reg_46
            case (stall0) 
               ...
               1'b0:                begin
                  ...
                  // Call Stack: 
                  // in function thread1 called from dut.cc:57:26
                  s_reg_46 <= dut_Lti8s32_4_11_out1;
               end
         ...
         // at: dut.cc:82:34
         always @(s_reg_40[2:0] or s_reg_41 or s_reg_42 or s_reg_43[2:0] or s_reg_46 or dut_N_Mux_3_2_15_4_13_out1 or gs_ctrl0)
          begin :drive_arr_in1
            case (gs_ctrl0) 
               ...
               4'd08:                begin
                  ...
                  // at: dut.cc:69:16
                  // Call Stack: 
                  // in function thread1 called from dut.cc:69:16
               ...
               4'd10:                begin
                  if (s_reg_46) begin
                     ...
                     // Call Stack: 
                     // in function thread1 called from dut.cc:64:21
                     arr_in1 = dut_N_Mux_3_2_15_4_13_out1;
                  end
                  else begin
                     // op:thread1/OP104
                     // at: dut.cc:69:16
               ...
               4'd12:                begin
                  if (s_reg_41) begin
                     ...
                     // at: dut.cc:75:34
                     // Call Stack: 
                     // in function thread1 called from dut.cc:75:34
                     arr_in1 = 3'd0;
                  end
               end
         ...
         // at: dut.cc:64:21
         always @(stall0 or s_reg_41 or dut_Lti8s5_4_9_out1 or gs_ctrl2)
          begin :drive_arr_CE
            if (stall0) begin
               arr_CE = 1'b0;
            end
         ...
         // rtl_process:dut/drive_dut_Add2i1u3_4_8_in1
         // Sharing or Control mux
         // Sharing/Controlling 1 operation(s) on drive_dut_Add2i1u3_4_8_in1
         // at: dut.cc:57:17
         always @(s_reg_40[2:0] or gs_ctrl4)
          begin :drive_dut_Add2i1u3_4_8_in1
            if (gs_ctrl4) begin
               // op:thread1/OP40
               dut_Add2i1u3_4_8_in1 = s_reg_40[2:0];
            end
            else begin
               // op:thread1/OP40
               dut_Add2i1u3_4_8_in1 = 3'd0;
            end
         end

         // rtl_instance:dut/dut_Add2i1u3_4_8
         // Resource=dut_Add2i1u3_4, Function=add : Inputs=3 Outputs=5S
         // Implements 1 operation(s)
         // at: dut.cc:57:19
         assign dut_Add2i1u3_4_8_out1 = {2'b00, dut_Add2i1u3_4_8_in1} + 5'd01;

         // rtl_instance:dut/dut_Lti8s5_4_9
         // Resource=dut_Lti8s5_4, Function=lt : Inputs=5S Outputs=1
         // Implements 1 operation(s)
         // at: dut.cc:57:26
         assign dut_Lti8s5_4_9_out1 = dut_Add2i1u3_4_8_out1[4] ^ dut_Add2i1u3_4_8_out1 < 5'd08;

         // rtl_instance:dut/dut_Add2i1s32_4_10
         // Resource=dut_Add2i1s32_4, Function=add : Inputs=32S Outputs=32S
         // Implements 1 operation(s)
         // at: dut.cc:57:32
         assign dut_Add2i1s32_4_10_out1 = s_reg_43 + 32'd0000000001;

         // rtl_instance:dut/dut_Lti8s32_4_11
         // Resource=dut_Lti8s32_4, Function=lt : Inputs=32S Outputs=1
         // Implements 1 operation(s)
         // at: dut.cc:57:26
         assign dut_Lti8s32_4_11_out1 = dut_Add2i1s32_4_10_out1[31] ^ dut_Add2i1s32_4_10_out1 < 32'd0000000008;
         ...
         // rtl_instance:dut/dut_N_Mux_3_2_15_4
         always @(s_reg_42 or s_reg_43[2:0] or dut_LessThan_32Ux32U_1U_4_12_out1)
          begin :dut_N_Mux_3_2_15_4_13
            if (dut_LessThan_32Ux32U_1U_4_12_out1) begin
               dut_N_Mux_3_2_15_4_13_out1 = s_reg_43[2:0];
            end
            else begin
               dut_N_Mux_3_2_15_4_13_out1 = s_reg_42;
            end
         end

         // rtl_instance:dut/dut_Add2i1u3_4_14
         // Resource=dut_Add2i1u3_4, Function=add : Inputs=3 Outputs=5S
         // Implements 1 operation(s)
         // at: dut.cc:54:27
         assign dut_Add2i1u3_4_14_out1 = {2'b00, s_reg_40[2:0]} + 5'd01;

         // rtl_instance:dut/dut_Lti7s5_4_15
         // Resource=dut_Lti7s5_4, Function=lt : Inputs=5S Outputs=1
         // Implements 1 operation(s)
         // at: dut.cc:54:21
         assign dut_Lti7s5_4_15_out1 = s_reg_40[4] ^ s_reg_40[4:0] < 5'd07;
         ...
         //   SRCLOC: cynw_p2p.h:5073:4
         //    FSM: global_state == 26
         always @(s_reg_41 or s_reg_46 or dut_Lti8s5_4_9_out1 or global_state)
         ...
         always @(posedge clk)
          begin :drive_din_m_unvalidated_req
            if (rst == 1'b0) begin
               ...
               din_m_unvalidated_req <= dut_N_Muxb_1_2_8_4_1_out1;
            end
         end

         // rtl_instance:dut/dut_N_Muxb_1_2_8_4
         // This resource is split across multiple concurrent processes.
         // See line:1216
         always @(din_vld or din_m_busy_req_0 or din_m_unvalidated_req)
          begin :dut_N_Muxb_1_2_8_4_1
            if (din_m_busy_req_0) begin
               dut_N_Muxb_1_2_8_4_1_out1 = din_m_unvalidated_req;
            end
            else begin
               dut_N_Muxb_1_2_8_4_1_out1 = din_vld;
            end
         end
