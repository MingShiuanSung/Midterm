...
define_hls_config   dut UNROLL   --flatten_arrays=all -DUNROLL
define_hls_config   dut PIP_URL  -DII=2 --flatten_arrays=all -DUNROLL
define_hls_config   dut USE_ALL  --dpopt_auto=op,expr -DII=2 --flatten_arrays=all -DUNROLL
#
