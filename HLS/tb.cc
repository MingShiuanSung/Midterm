...
{
    resp_file << " " << value.range(32*1-1,32*0) << " " << value.range(32*2-1,32*1)
              << " " << value.range(32*3-1,32*2) << " " << value.range(32*4-1,32*3) 
              << " " << value.range(32*5-1,32*4) << " " << value.range(32*6-1,32*5) 
              << " " << value.range(32*7-1,32*6) << " " << value.range(32*8-1,32*7) << endl;
}
